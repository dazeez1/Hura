...
class HuraAPI {
  constructor() {
    ...
    this.endpoints.chatHistory = "http://localhost:4000/api/chat/history";
  }
  ...
  async askQuestion(text, sessionId = null, userId = null) {
    const endpoint = "http://localhost:4000/api/chat/ask";
    const body = { text };
  ...
  async startSession(userId = null, sessionType = "chatbot") {
    const endpoint = "http://localhost:4000/api/chat/session/start";
  ...
  async recordMessage(
    ...
    const endpoint = `http://localhost:4000/api/chat/session/${sessionId}/message`;
  ...
  async endSession(sessionId) {
    const endpoint = `http://localhost:4000/api/chat/session/${sessionId}/end`;
